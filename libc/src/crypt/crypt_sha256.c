...
//TODO(ccgo)			0,10,20,21,1,11,12,22,2,3,13,23,24,4,14,
//TODO(ccgo)			15,25,5,6,16,26,27,7,17,18,28,8,9,19,29 };
//TODO(ccgo)		for (i=0; i<10; i++) p = to64(p,
//TODO(ccgo)			(md[perm[i][0]]<<16)|(md[perm[i][1]]<<8)|md[perm[i][2]], 4);
//TODO(ccgo)		p = to64(p, (md[31]<<8)|md[30], 3);
//TODO(ccgo)		*p = 0;
